...
#define   ASYNC_FLOW_STOP_THRESHOLD             (ASYNC_RXQ_SIZE-(ASYNC_MAX_SIZE+ASYNC_MAX_SIZE/2))
  ...
  enum{BUS_HELPER_EV_ASYNC_SEND=1<<0,BUS_HELPER_EV_SPI_COMPLETE_CMD=1<<1,BUS_HELPER_EV_SPI_CLEAR_CMD=1<<2,BUS_HELPER_EV_ASYNC_CLOSE=1<<3};

  //all helper task events
  #define BUS_HELPER_EV_ALL (BUS_HELPER_EV_ASYNC_SEND|BUS_HELPER_EV_SPI_COMPLETE_CMD|BUS_HELPER_EV_SPI_CLEAR_CMD|BUS_HELPER_EV_ASYNC_CLOSE)
